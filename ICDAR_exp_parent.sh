...
python $WorkDir/scripts/nbest_hyp_crawler.py ./${N}-best-test-words.txt ./${N}-best-compliant-test-words.txt $WorkDir/histogram-${N}-best.txt ./crawler-log.txt
python $WorkDir/scripts/char_transcript_extractor.py ./${N}-best-compliant-test-words.txt  ./${N}-best-compliant-test-chars.txt
...
rm $WorkDir/PREC-REC/NER-DECODE/*
python $WorkDir/scripts/extract_ner_parenthesized.py $TmpDir/decode/lattices/SeparateSimbols-wordtest.txt .
...
rm $WorkDir/PREC-REC/NER-GT/*
python $WorkDir/scripts/extract_ner_parenthesized.py $TmpDir/SeparateSimbols-GT_test.txt .
for f in *; do sed 's/^ //g' -i $f; done
...
python $WorkDir/scripts/alt_dist_edicion_custom_saturated.py ./NER-GT ./NER-DECODE >> $WorkDir/res_exp.txt
...
python $WorkDir/scripts/calc_prec_rec.py ./NER-GT ./NER-2500-BEST >> $WorkDir/res_exp.txt
python $WorkDir/scripts/alt_dist_edicion_custom_saturated.py ./NER-GT ./NER-2500-BEST >> $WorkDir/res_exp.txt
